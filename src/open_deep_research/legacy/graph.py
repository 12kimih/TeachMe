...
from open_deep_research.prompts import final_section_writer_instructions, query_writer_instructions, report_planner_instructions, report_planner_query_writer_instructions, section_grader_instructions, section_writer_inputs, section_writer_instructions
from open_deep_research.state import Feedback, Queries, ReportState, ReportStateInput, ReportStateOutput, SectionOutputState, Sections, SectionState
from open_deep_research.utils import format_sections, get_config_value, get_search_params, get_today_str, select_and_execute_search
...
async def write_section(state: SectionState, config: RunnableConfig) -> Command[Literal[END, "search_web"]]:
    ...
    # Grade prompt
    section_grader_message = "Grade the report and consider follow-up questions for missing information. " "If the grade is 'pass', return empty strings for all follow-up queries. " "If the grade is 'fail', provide specific search queries to gather missing information."
